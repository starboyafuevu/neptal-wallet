...
if($errcode!=112){  
  ...
  $insertSQL = sprintf("UPDATE `org_login` SET  `pin`=%s, `status`=%s  WHERE `orgunique_id`=%s",
...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Hi..<span style="color: Green; font-weight: bold"><?php echo $_SESSION['MM_org'];?></span>..Enter a code. For the use of transfer and funding of Wallet </p>
