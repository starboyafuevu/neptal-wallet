        ...
        <div class="row justify-content-center">
            <div class="col-xl-10 col-lg-12 col-md-12">
                <div class="card o-hidden border-0 shadow-lg my-5">
                    ...
                    <p><span class="brand-text font-weight-bold" style="color: red">Kclem<span style="color: green">Venture</span> </span></p>
                  </div>
                        <div class="row">
                                   ...
                                   <span>  <?php echo $rnt?>  </span>
                                    ...
                                    <div class="form-group">
                                         ...
                                         <div class="input-group-append">
                                            ...
                                            <input type="phone" name="phone" autocomplete="off" value="" class="form-control form-control-user"  aria-describedby="texthelp"
