...
<body class="bg-gradient-light" onblur="ifvisible()" onresize = "CheckWindow();" onload = "CheckWindow();">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-10 col-lg-12 col-md-12">
                <div class="card o-hidden border-0 shadow-lg my-5">
                    ...
                    <div class="orgin" style="text-align: center; margin-top: 50px;  font-size: 30px;" >
                    <p><span class="brand-text font-weight-bold" style="color: red">Neptal<span style="color: green">Wallet</span> </span></p>
                  </div>
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="register-box">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Welome Back!</h1><br>
                                     <?php 
                                     if($err=112)  {?>  
                                    <span style="color: red; font-weight: bold;"><?php echo $Err?></span>
                                     <?php }?>
                                   <span>  <?php echo $rnt?>  </span>
                                    </div>
                                    ...
                                    <div class="form-group">
                                         ...
                                         <div class="input-group-append">
                                            ...
                                            <input type="email" name="email" autocomplete="off" value="" class="form-control form-control-user"  aria-describedby="texthelp"
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="input-group-append">
                                            ...
                                            <input type="password" name="pwd" value=""  placeholder="Password" class="form-control form-control-user">
                                      ...
                                      <button  class="btn btn-primary btn-icon-split btn-user btn-block" name="login-btn">
                                    ...
                                    <div class="text-center">
                                            <a href="resetp.php" class="small">Forgot Password</a>
                                        </div>
                                        <div class="text-center">
                                            <p  class="small">Already have an account?<a href="signup.php"> Click Here</a></p>
                                        </div>
                        ...
                        <div class="col-lg-4 col-md-12 col" style="margin-top: 25%;">
              <div class="card">
              <span class="fas fa-exclamation-triangle"><span style=""> Note</span></span>
                   <p style="color: Black; font-weight: bold; text-align: center;">Hi dear user!<br>Please don't share your Information to straingers<br>
                   and login with a secured device.<br>Thank's for your Cooperation.!</p>
                   <div class="link" style="margin-left: 70px; margin: auto;">
